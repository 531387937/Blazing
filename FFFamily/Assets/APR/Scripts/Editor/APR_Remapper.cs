...
public class APR_Remapper : EditorWindow
{
    
    //Editor
    public Texture tex;
    private static APR_Remapper _instance;
	...
	void OnGUI()
	{
		...
		if(GUILayout.Button("Remap Active Ragdoll"))
		{
			RemapRagdoll();
		}
	}
	...
	void RemapRagdoll()
	{
		...
		Debug.Log("APR_Player has been remapped");

...
namespace FluffyUnderware.CurvyEditor
{
    ...
    public static class CurvyEditorUtility
    {
        ...
        [Obsolete("Call HelpURL(string) instead")]
        ...
        public static string GetCurvyRootPath()
        {
            ...
            if (System.IO.File.Exists(Application.dataPath + "/Plugins/Curvy/Base/CurvySpline.cs"))
                return "Plugins/Curvy/";
            
            // Still no luck? Do a project search
            var guid = AssetDatabase.FindAssets("curvyspline");
            if (guid.Length == 0)
            {

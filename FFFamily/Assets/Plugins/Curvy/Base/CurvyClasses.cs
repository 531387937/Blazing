...
namespace FluffyUnderware.Curvy
{
    ...
    public interface ICurvyMetadata //DESING what is the use of this interface?
    {
    }
    /// <summary>
    ...
    {
        /// <summary>
        /// Valide positions are from 0 (Start) to 1 (End)
        /// </summary>
        Relative = 0,
        /// <summary>
        /// Valide positions are from 0 (Start) to Length (End). Also know as Absolute.
        /// </summary>
        WorldUnits = 1,
    }
